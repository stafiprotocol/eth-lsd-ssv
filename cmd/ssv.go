...
import (
	...
	"github.com/stafiprotocol/eth-lsd-ssv-client/pkg/log"
	"github.com/stafiprotocol/eth-lsd-ssv-client/pkg/utils"
	"github.com/stafiprotocol/eth-lsd-ssv-client/task"
)
...
func startSsvCmd() *cobra.Command {
  ...
  lsdTokenAddress: %s
  viewMode: %t`,
				cfg.LogFilePath, logLevelStr, cfg.Eth1Endpoint, cfg.Eth2Endpoint, cfg.Contracts.SsvNetworkAddress,
				cfg.Contracts.SsvNetworkViewsAddress, cfg.TargetOperators, cfg.PoolReservedBalance,
				cfg.Contracts.LsdFactoryAddress,
				cfg.Contracts.LsdTokenAddress, viewMode)
